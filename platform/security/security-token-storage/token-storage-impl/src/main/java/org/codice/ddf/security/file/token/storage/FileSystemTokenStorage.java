...
public class FileSystemTokenStorage implements TokenStorage {
  ...
  public boolean create(
    ...
    if (tokenInformation == null) {
      ...
      String json = TokenInformationImpl.getJson(sourceId, accessToken, refreshToken, discoveryUrl);
  ...
  public TokenInformation read(String userId) {
    ...
    return TokenInformationImpl.fromJson(id, userId, json);
  }
  ...
  public TokenInformation.TokenEntry read(String userId, String sourceId) {
    ...
    TokenInformation tokenInformation = TokenInformationImpl.fromJson(id, userId, json);
   ...
   */
  @Override
  public boolean delete(String userId, String sourceId) {
    ...
    String json = TokenInformationImpl.removeTokens(tokenInformation, sourceId);
    return writeToFile(contentItemPath, json);
  }

  private boolean writeToFile(Path contentItemPath, String tokenJson) {
