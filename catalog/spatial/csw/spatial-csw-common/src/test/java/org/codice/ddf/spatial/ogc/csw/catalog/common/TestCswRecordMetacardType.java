...
public class TestCswRecordMetacardType {
    ...
    public void testCswMetacardAllSummaryRecordAttributesSetWithSingleValues() {
        ...
        assertThat((String) metacard.getAttribute(CswRecordMetacardType.CSW_RELATION).getValue(),
                equalTo("relation_1"));
        assertThat(metacard.getAttribute(CswRecordMetacardType.CSW_MODIFIED).getValue(),
                equalTo(cswModifiedDate.toString()));
    ...
    public void testCswMetacardMultipleSubstitutionNameAttributesSet() {
        ...
        metacard.setAttribute(CswRecordMetacardType.CSW_CREATED, cswCreatedDate.toString());
        cal.set(2013, 3, 3);
        Date cswDateAccepted = cal.getTime();
        metacard.setAttribute(CswRecordMetacardType.CSW_DATE_ACCEPTED, cswDateAccepted.toString());

        assertThat(metacard.getAttribute(CswRecordMetacardType.CSW_DATE).getValue(),
                equalTo(cswDate));
        assertThat(metacard.getAttribute(CswRecordMetacardType.CSW_MODIFIED).getValue(),
                equalTo(cswModifiedDate.toString()));
        assertThat(metacard.getAttribute(CswRecordMetacardType.CSW_CREATED).getValue(),
                equalTo(cswCreatedDate.toString()));
        assertThat(metacard.getAttribute(CswRecordMetacardType.CSW_DATE_ACCEPTED).getValue(),
                equalTo(cswDateAccepted.toString()));
    }
